...
public class YoutubeStepDefs {
    ...
    @When("User seraches for cars")
    public void user_seraches_for_cars() throws InterruptedException {
        Thread.sleep(2000);
        yobj.youtubeSearchBox.sendKeys("CARS" + Keys.ENTER);
        Thread.sleep(2000);
    }

    @Then("User should see results realted to cars")
    public void user_should_see_results_realted_to_cars() {
        String actual = Driver.getDriver().getTitle();
        System.out.println(actual);
    ...
    @When("User searches for Homes")
    public void user_searches_for_Homes() throws InterruptedException {
        Thread.sleep(2000);
        yobj.youtubeSearchBox.sendKeys("Homes" + Keys.ENTER);
        Thread.sleep(2000);
    }

    @Then("User should see results realted to Homes")
    public void user_should_see_results_realted_to_Homes() {
        String actual = Driver.getDriver().getTitle();
        System.out.println(actual);
        String expected = "Homes";
        Assert.assertTrue("Does not contain", actual.contains(expected) );
    }
